...
### Review proposals
Review proposals on the forum & leave feedback for proposal authors [here](https://community.radworks.org/c/governance/proposals/18).

### Delegate voting power
Find delegates and delegate voting power [here](https://www.tally.xyz/gov/radworks/delegates).

### Vote offchain
View and vote on active Snapshot polls [here](https://snapshot.org/#/gov.radworks.eth).

### Vote onchain
View and vote on active onchain submissions [here](https://www.tally.xyz/gov/radworks).
